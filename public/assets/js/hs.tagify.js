	...
	$.HSCore.components.HSTagify = {
		...
		init: function (el, options) {
			...
			var context = this,
				...
				dataSettings = el.attr("data-hs-tagify-options")
					? JSON.parse(el.attr("data-hs-tagify-options"))
					: {},
				settings = {};
			...
			// Clear Tags
			$(settings.clearBtnSelector).on(
				"click",
				newTagify.removeAllTags.bind(newTagify)
			);
